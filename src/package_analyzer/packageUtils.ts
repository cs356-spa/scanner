...
export const DEFAULT_MAX_NOTABLE_STRING_COUNT_LIMIT = 50;
...
export async function collectPackageNotableStringsIntoDict(dictToFill: PackageStringsByVersionMap, packageDirPath: string, version: string, limit: number): Promise<void> {
